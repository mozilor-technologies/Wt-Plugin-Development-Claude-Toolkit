...
## Wrapper Integration
<!-- Include this section ONLY when this repo is an addon. Omit entirely for the wrapper repo. -->
...
- Task {N} in {wrapper-slug}: {task name} — must complete before this addon's Task 1
